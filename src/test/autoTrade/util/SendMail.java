...
*/
	...
	public void send() {
		...
		try {
			final Address addrFrom = new InternetAddress("自分のメールアドレス", "送信者の表示名", ENCODE);
			message.setFrom(addrFrom);

			final Address addrTo = new InternetAddress("宛先メールアドレス", "受信者の表示名", ENCODE);
